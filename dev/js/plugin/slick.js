...
(function(factory) {
    ...
    Slick = (function() {
        ...
        function Slick(element, settings) {
            ...
            _.defaults = {
                ...
                asNavFor: null,
                prevArrow:
                    '<div data-role="none" class="slick-prev" aria-label="Previous" tabindex="0" role="button">Previous</div>',
                nextArrow:
                    '<div data-role="none" class="slick-next" aria-label="Next" tabindex="0" role="button">Next</div>',
                autoplay: false,
                autoplaySpeed: 3000,
                centerMode: false,
                centerPadding: "50px",
    ...
    Slick.prototype.destroy = function(refresh) {
        var _ = this,
            $clones = _.$slider.find(".slick-cloned");
