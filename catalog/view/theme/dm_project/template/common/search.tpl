<div id="search" class="input-group">
  ...
  <div class="input-group-btn">
    <button type="button" class="btn btn-default btn-lg"><img src="/image/icons/search-icon.png" alt="Search button"></button>
  </div>
</div>
<?php if ($live_search_ajax_status):?>
<link rel="stylesheet" type="text/css" href="catalog/view/theme/dm_project/stylesheet/live_search.css" />
        ...
        $('#search input[name=\'search\']').autocomplete({
            'source': function(request, response) {
                if ($(live_search.selector + ' input[type=\'text\']').val() == '') {
                    ...
                    html +=	'<img class="loading" src="image/preload/loading.gif" />';
                    html +=	'</li>';
