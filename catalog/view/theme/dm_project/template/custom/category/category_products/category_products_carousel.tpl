...
<div id="products-<?php echo !empty($unique_id) ? $unique_id . '-' : ''; ?>carousel">
...
<script type="text/javascript"><!--
$('#products-<?php echo !empty($unique_id) ? $unique_id . '-' : ''; ?>carousel').owlCarousel({
    items: 3,
    itemsCustom: false,
    itemsDesktop: [1199, 3],
