...
<div class="container">
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <?php } ?>
      <?php if ($next_payment_url || $invoice['download_href']) { ?>
      <div class="buttons clearfix">
        <div class="pull-right">
          <?php if ($next_payment_url) { ?>
          <a href="<?php echo $next_payment_url; ?>" class="btn btn-primary" type="button"><i class="fa fa-credit-card" aria-hidden="true"></i> <?php echo $button_payment; ?></a>
          <?php } ?>
          <?php if ($invoice['download_href']) { ?>
            <a href="<?php echo $invoice['download_href']; ?>" class="btn btn-primary" type="button"><i class="fa fa-download" aria-hidden="true"></i> <span class="hidden-xs hidden-sm"><?php echo $button_invoice_download; ?></span></a>
          <?php } ?>
        </div>
      </div>
      <?php } ?>
